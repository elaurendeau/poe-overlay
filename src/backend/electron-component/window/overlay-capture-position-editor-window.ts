...
export function createCaptureOverlayPositionEditorWindow(): BrowserWindow {
    ...
    if (process.env.WEBPACK_DEV_SERVER_URL) {
        ...
        overlay.loadURL((process.env.WEBPACK_DEV_SERVER_URL as string) + "overlay-capture-position-editor");
    ...
    electronComponents.windows[OVERLAY_CAPTURE_POSITION_EDITOR_WINDOW_KEY] = overlay;
    return overlay;
}
